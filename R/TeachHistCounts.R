...
#' @param NOfSimData (default=100000) Number of simulated data points. Higher NOfSimData results in better precision but possibly not all points are considered.
#' @param SeedValue (default=NULL) Can be any integer and makes simulated points reproduceable.
#' @param PrintCounts (default=TRUE) Set PrintCounts=FALSE to supress the printing of relative frequencies in the histogram.
...
ClPlot=ClPlot+ggplot2::labs(y="Counts")
